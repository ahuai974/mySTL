#ifndef PORJECT1_UNINITIALIZED_H
#define PORJECT1_UNINITIALIZED_H
//trivially copy assignable 能否简单的复制分配
//这里的算法与algobase中大同小异，如果对象能简单的复制分配就调用algobase中的算法，否则使用构造析构的方法实现。
//这里的copy与algobase中的copy不同，如果是false type利用开辟空间的方式复制，如果是true type则是algobase。
namespace mySTL
{
	//*****************************************************************************************
	// uninitialized_copy
...
#endif // !PORJECT1_UNINITIALIZED_H
